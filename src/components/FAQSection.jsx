      ...
      <div className=" grid grid-cols-2 ">
        <div className="ml-10 w-[120%]">
          ...
          <div className="mb-4 flex items-center">
            <span className="text-[40px] text-blue-600"><RxDividerVertical /></span>
          ...
          <hr className="mb-4 border-[1.8px] border-blue-500"/>
          <div className="gap-4 flex items-center mb-4">
            <span className="text-blue-600 text-xl font-semibold">+</span>How do I share my reports and
            medical cases with the clinic of my choice?
          </div>
