...
const HospitalDetail = () => {
  ...
  return (
    <div className="container mx-auto bg-white mt-10 ">
      <div className="p-4">
        <h1 className="text-center text-red-500 text-4xl mt-10 font-bold">
          Hospitals
        </h1>
        <div className="text-2xl font-bold text-center mt-2 ">
          Recommended <span className="text-blue-500">Hospitals</span>
        </div>
      </div>
      ...
      <div className="slider-container p-10  ">
        ...
        <div className="text-center font-semibold mt-10">
          ...
          <span className="text-red-500 underline">Explore all Hospitals</span>
        </div>
      </div>
    </div>
  );
