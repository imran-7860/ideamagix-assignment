  ...
  return (
    <div className='container mx-auto bg-blue-500'>
        <div className="text-white text-center p-10">
            ...
            <h1 className="text-4xl font-semibold ">We have team of healthcare experts</h1>
            <div className="mt-5 flex items-center justify-center font-semibold">
                <button className='bg-blue-700 p-2 px-10 rounded'>Get in Touch</button>
                <span className="text-[40px] "><RxDividerVertical /></span>
